...
import { ArrowLeft, Clock, Calendar, CheckCircle, Sparkles, Hand, ArrowRight, Shield, Zap, Activity, Heart, Star } from 'lucide-react';
                ...
                <div className="relative z-10 container mx-auto px-6 h-full flex flex-col justify-center">
                    ...
                    <div className="flex flex-wrap gap-4 mb-6">
                        <motion.div
                            ...
                            className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass border border-emerald-500/30 w-fit bg-emerald-500/10"
                        >
                    ...
                    <div className="lg:col-span-1">
                        ...
                        >
                            ...
                            <motion.div
                                ...
                                className="glass p-4 rounded-2xl border border-emerald-500/30 bg-emerald-500/5 text-center relative overflow-hidden group"
                            >
                                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/5 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000" />
                                <p className="text-emerald-400 font-bold tracking-widest uppercase text-[10px] mb-1">
                                    Website Launch Offer
                                </p>
                                <p className="text-white font-serif font-bold text-sm">
                                    Flat <span className="text-emerald-400">₹499</span> for first 50 seekers
                                </p>
                            </motion.div>
                                    ...
                                    <div className="flex items-center gap-4 p-4 rounded-xl bg-white/5 border border-white/5">
                                        ...
                                        <div>
                                            ...
                                            <div className="flex flex-col">
                                                <span className="text-xs text-[var(--color-text-muted)] line-through opacity-50">₹1,800</span>
