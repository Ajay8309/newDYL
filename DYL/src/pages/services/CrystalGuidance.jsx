...
import { ArrowLeft, Clock, Calendar, CheckCircle, Sparkles, Gem, ArrowRight, Shield, Zap, Hexagon, Filter } from 'lucide-react';
import heroImg from '../../assets/Crystal-and-pendulum-healing-evening.jpg';
                ...
                <div className="relative z-10 container mx-auto px-6 h-full flex flex-col justify-center">
                    ...
                    <div className="flex flex-wrap gap-4 mb-6">
                        <motion.div
                            ...
                            className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass border border-cyan-500/30 w-fit bg-cyan-500/10"
                        >
                    ...
                    >
                        Crystal <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-300 to-teal-300">Guidance</span>
                    </motion.h1>
                    ...
                    >
                        Harness the earth's vibrational medicine. Discover the stones that resonate with your soul's frequency.
                    </motion.p>
                </div>
            </section>
                        ...
                        <div className="glass rounded-[2rem] p-8 border border-white/5">
                            ...
                            <div className="space-y-8">
                                <div className="flex gap-6">
                                    <div className="flex-shrink-0 w-12 h-12 rounded-full bg-cyan-500/20 flex items-center justify-center text-cyan-300 font-bold text-xl border border-cyan-500/30">1</div>
                                    <div>
                                        <h4 className="text-xl font-bold mb-2">Energy Assessment</h4>
                                        <p className="text-[var(--color-text-muted)]">We discuss your current challenges and goals to determine which energetic frequencies are missing or blocked in your field.</p>
                                    </div>
                                </div>
                                <div className="flex gap-6">
                                    <div className="flex-shrink-0 w-12 h-12 rounded-full bg-cyan-500/20 flex items-center justify-center text-cyan-300 font-bold text-xl border border-cyan-500/30">2</div>
                                    <div>
                                        <h4 className="text-xl font-bold mb-2">Crystal Matching</h4>
                                        <p className="text-[var(--color-text-muted)]">I intuitively select stones that resonate with your unique vibration. We explore how to use them—wearing, placing, or meditating.</p>
                                    </div>
                                </div>
                                <div className="flex gap-6">
                                    <div className="flex-shrink-0 w-12 h-12 rounded-full bg-cyan-500/20 flex items-center justify-center text-cyan-300 font-bold text-xl border border-cyan-500/30">3</div>
                                    <div>
                                        <h4 className="text-xl font-bold mb-2">Activation Ritual</h4>
                                        <p className="text-[var(--color-text-muted)]">I teach you how to cleanse, charge, and program your crystals so they become active tools for your transformation, not just paperweights.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="lg:col-span-1">
                        ...
                        >
                            ...
                            <motion.div
                                ...
                                className="glass p-4 rounded-2xl border border-cyan-500/30 bg-cyan-500/5 text-center relative overflow-hidden group"
                            >
                                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/5 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000" />
                                <p className="text-cyan-400 font-bold tracking-widest uppercase text-[10px] mb-1">
                                    Website Launch Offer
                                </p>
                                <p className="text-white font-serif font-bold text-sm">
                                    Flat <span className="text-cyan-400">₹499</span> for first 50 seekers
                                </p>
                            </motion.div>
                            ...
                            <div className="glass p-8 rounded-[2rem] border border-cyan-500/30 shadow-[0_0_30px_rgba(6,182,212,0.1)] relative overflow-hidden">
                                    ...
                                    <div className="flex items-center gap-4 p-4 rounded-xl bg-white/5 border border-white/5">
                                        ...
                                        <div>
                                            ...
                                            <div className="flex flex-col">
                                                <span className="text-xs text-[var(--color-text-muted)] line-through opacity-50">₹1,500</span>
                                ...
                                <Link to="/booking?service=Crystal Healing">
                                    <motion.button
                                        whileHover={{ scale: 1.02, boxShadow: '0 0 20px rgba(6,182,212,0.4)' }}
                                        whileTap={{ scale: 0.98 }}
                                        className="w-full py-4 rounded-xl font-bold text-white bg-gradient-to-r from-cyan-400 to-teal-500 hover:from-cyan-300 hover:to-teal-400 shadow-lg shadow-cyan-400/30 transition-all flex items-center justify-center gap-2"
                                    >
